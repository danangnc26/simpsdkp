...
var pdfjs_dir =  base + "/assets/global/plugins/pdfjs";
var DEFAULT_URL = pdfjs_dir + '/web/compressed.tracemonkey-pldi-09.pdf';
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = pdfjs_dir + '/web/images/';
  PDFJS.workerSrc = pdfjs_dir + '/build/pdf.worker.js';
  PDFJS.cMapUrl = pdfjs_dir + '/web/cmaps/';
